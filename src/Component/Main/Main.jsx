...
const Main = () => {
  ...
  const Data=[
...

   {
    ...
    grade : 'CULTURAL RELAX',
    fees : '$700',
    description :"One of the most remarkable Australian natural gifts is the Great Barrier Reef. The allmark of this place is 'lavish' and 'beauty'.Always interesting to be in this place. " 
...

   {
    ...
    grade : 'CULTURAL RELAX',
    fees : '$790',
    description :"Angkot wat represents the entire range of khmer art from the 9th to the 15th century. This temple is considered the heart and soul of Cambodin. This place known for its luxurious stays and adventurous activities" 
          ...
          <div key={id} className='singleDestination'>
            ...
            <div className="cardInfo">
              ...
              <button className="btn flex">
                ...
                DETAILS
                <HiOutlineClipboardCheck className="icon3"/>
              </button>
              </div>
